...
def find_best_meal_combinations(numMeals, constraints, diet, time_limit=3):
    ...
    for combo in itertools.combinations(meals, numMeals):
        ...
        valid_combinations.append((combo, nutrients))
    ...
    if len(valid_combinations) < 1000 and numMeals > 1:
        ...
        for combo in itertools.combinations(meals, numMeals - 1):
            ...
            backup_combinations.append((combo, nutrients))
